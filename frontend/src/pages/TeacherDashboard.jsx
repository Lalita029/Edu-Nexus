...
const TeacherDashboard = () => {
  ...
  const fetchChapters = async () => {
    setLoading(true);
    try {
      const res = await apiFetch('/api/teacher/chapters', {
  ...
  const fetchPerformance = async () => {
    setLoading(true);
    try {
      const res = await apiFetch('/api/teacher/performance', {
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await res.json();
      if (!res.ok) throw new Error(data.message);
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      const res = await apiFetch('/api/teacher/generate-quiz', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
  ...
  const handleDeleteChapter = async (id, title) => {
    ...
    try {
      const res = await apiFetch(`/api/teacher/chapters/${id}`, {
        method: 'DELETE',
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await res.json();
  ...
  const handleDeleteQuiz = async (id, title) => {
    ...
    try {
      const res = await apiFetch(`/api/teacher/quizzes/${id}`, {
        method: 'DELETE',
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await res.json();
